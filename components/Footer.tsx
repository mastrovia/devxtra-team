      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-1">
            <Link
              href="/"
              className="text-2xl font-bold tracking-tight text-foreground flex items-center mb-6"
            >
              Devxtra Team
            </Link>
            ...
            <div className="flex gap-4">
              {[Github, Twitter, Linkedin].map((Icon, i) => (
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  className="hover:text-foreground hover:bg-muted/50 rounded-none"
                >
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Join our briefing on future technologies.
            </p>
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            © 2025 Devxtra Team. All rights reserved.
          </p>
          <p className="text-sm text-muted-foreground font-mono">
            Designed by Devxtra. Built by Devxtra.
          </p>
        </div>
      </div>
    </footer>
