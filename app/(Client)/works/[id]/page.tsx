        ...
        <div className="container mx-auto px-6 py-12 pt-32 min-h-screen">
                ...
                <div className="w-full max-w-4xl">
                    <div className="flex items-center gap-4 mb-4 flex-wrap">
                        ...
                        {work.budget && (
                            <Badge
                                variant="default"
                                className="text-base px-3 py-1 font-mono bg-primary/10 text-primary hover:bg-primary/20 border-primary/20"
                            >
                                {work.budget}
                            </Badge>
                        )}
            ...
            {work.images && work.images.length > 0 && (
                <section className="mb-16 animate-in fade-in slide-in-from-bottom-6 duration-600">
                    <h2 className="text-2xl font-bold tracking-tight mb-8">Project Gallery</h2>
